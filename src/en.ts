export default {
  ...
  motorZPPGetTopAndBottomLevelsForCheckIncludeBelowS1Action: 'Since there are motor levels below S1, the bottom of our range is determined by the lowest Motor Level.',
